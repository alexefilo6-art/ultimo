...
export default function App() {
  ...
  const renderLanding = () => (
    <div className="min-h-screen bg-white text-[#121212] font-inter selection:bg-[#65c962] selection:text-black">
      <FacBot />
      {/* Nav */}
      <nav className="flex justify-between items-center px-[5%] py-8 md:py-5 bg-white border-b-3 border-black sticky top-0 z-[1000]">
      ...
      {/* Hero */}
      <header className="grid md:grid-cols-2 items-center gap-12 max-w-7xl mx-auto mt-16 px-[5%] overflow-hidden">
        <motion.div 
  ...
  const renderArticles = () => (
    <div className="min-h-screen bg-white text-[#121212] font-inter">
      <nav className="flex justify-between items-center px-[5%] py-5 bg-white border-b-3 border-black sticky top-0 z-[1000]">
        ...
        <div className="font-syne text-2xl font-extrabold uppercase">Articoli</div>
